...
@section[#:tag-prefix "ps2"]{Problem 0}

Revise the one-page description of your chosen programming language
based on the feedback on @secref{PS1} handed back in class on September
11.  Exchange memos with your partner.  Critically mark up your
...
produce any answer that is consistent with the semantics.
